...
export const getKey = async () => {
    return await getSHA256("cryption-" + "rishabh" + "-cryption");
}
...
export const encrypt = async (data, filename, eKey) => {
    //var eKey = "Data_sharing_ipfs_rishabh";
    //await getKey();
...
export const decrypt = async (file, eKey) => {
    //var eKey = "Data_sharing_ipfs_rishabh";
